        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasPremiumMembership = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembershipDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MembershipDetails_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorBook", x => new { x.AuthorsId, x.BooksAuthoredId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorBook_Books_BooksAuthoredId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Categories_BasicCategories_BaseCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_MembershipDetails_MembershipId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BorrowDetails_Books_UserId",
                        column: x => x.UserId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorBook_BooksAuthoredId",
                table: "AuthorBook",
                column: "BooksAuthoredId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasicCategories_BaseCategoryName",
                table: "BasicCategories",
                column: "BaseCategoryName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_Title_LanguageId",
                table: "Books",
                columns: new[] { "Title", "LanguageId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipDetails_CityId",
